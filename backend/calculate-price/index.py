...
def handler(event: dict, context) -> dict:
    ...
    # Если все точки маршрута в спецзоне — весь маршрут по спецтарифу
    all_special = all(is_special_addr(c) for c in all_cities)
    # Если все в Крыму — обычный тариф
    ...
    if result:
        ...
        if all_special:
            # Все точки в спецзоне — весь маршрут по спецтарифу
            ...
            # Все точки вне спецзоны — обычный тариф

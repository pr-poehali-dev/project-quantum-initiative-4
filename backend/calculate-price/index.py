...
KPP_COORDS = {
    ...
    "novoshakht":   (47.758, 39.925),  # Новошахтинск (ДНР)
    "izvarino":     (48.143, 39.538),  # Изварино (ЛНР)
    "chertkovo":    (49.406, 40.174),  # Чертково (ЛНР)
    "bugaevka":     (49.213, 40.527),  # Бугаевка (ЛНР)

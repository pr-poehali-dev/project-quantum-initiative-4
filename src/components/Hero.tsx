...
export default function Hero() {
  ...
  return (
    <div className="relative" style={{ height: "100dvh", overflow: "hidden" }}>
      ...
      <div className="hidden sm:block absolute z-10 top-[160px] bottom-[44px] left-4">
        <div id="order" className="bg-black/70 backdrop-blur-md border border-[#F5A623]/50 rounded-3xl shadow-2xl p-5 w-[380px] h-full overflow-y-auto flex flex-col">
          <FormContent {...formProps} />
        </div>
      </div>

  ...
  return (
    <div className="relative" style={{ height: "100dvh", overflow: "hidden" }}>
      ...
      <div className="sm:hidden relative z-10 flex flex-col" style={{ height: "100dvh", overflow: "hidden" }}>
        ...
        <div ref={formRef} id="order" className="bg-black/70 backdrop-blur-md border-t border-[#F5A623]/30 rounded-t-3xl px-4 pt-5 pb-[52px] w-full overflow-y-auto" style={{ maxHeight: isYandex ? "50dvh" : "85dvh" }}>

...
export default function Hero() {
  ...
  return (
    <div className="relative" style={{ height: "100dvh", overflow: "hidden" }}>
      ...
      <div className="hidden sm:flex absolute z-10 bottom-[44px] right-4 bg-black/70 backdrop-blur-md border border-[#F5A623] rounded-2xl px-5 py-3 flex-col gap-1.5 shadow-2xl">
        <div className="flex items-center gap-3">
          <a href="tel:+79843348724" className="text-white text-lg font-bold hover:text-[#c8d44a] transition">
            +7 (984) 334-87-24
          </a>
          <div className="flex items-center gap-2">
            <a href="https://t.me/ug_transfer_online" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-[#26A5E4] flex items-center justify-center hover:scale-110 transition-transform">
              <svg viewBox="0 0 24 24" fill="white" className="w-5 h-5"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69.01-.03.01-.14-.07-.2-.08-.06-.19-.04-.27-.02-.12.03-1.99 1.27-5.62 3.72-.53.36-1.01.54-1.44.53-.47-.01-1.38-.27-2.06-.49-.83-.27-1.49-.42-1.43-.88.03-.24.37-.49 1.02-.75 4-1.73 6.67-2.88 8.02-3.45 3.81-1.58 4.6-1.86 5.12-1.87.11 0 .37.03.54.17.14.12.18.28.2.47-.01.06.01.24 0 .38z"/></svg>
            </a>
            <a href="https://wa.me/79843348724" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-[#25D366] flex items-center justify-center hover:scale-110 transition-transform">
            ...
            <a href="https://max.ru/u/f9LHodD0cOLfcwdQZmP_TA1hXG1fSHf_rVVPptGTy_7FmQh-zvIFpGfU_lg" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-[#5856D6] flex items-center justify-center hover:scale-110 transition-transform">
              <span className="text-white font-bold text-sm">M</span>
            </a>
          </div>
        </div>
        <p className="text-gray-400 text-sm">Закажите трансфер по телефону или в мессенджере</p>
      </div>
